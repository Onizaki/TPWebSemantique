...
<form role="form" class="form-horizontal" action="req_inscription.php" method="post" name="inscription">  
    ...
    <!-- REPONSE - Attribut action : Défini l'action a réaliser lorsque le formulaire est envoyé -->
    <!-- REPONSE - Attribut method : Spécifie la méthode HTTP a utiliser lors de l'envoi des données du formulaire -->
    <!-- qu'y a-t-il d'autre comme possiblité que post pour l'attribut method ? --> 
    <!-- REPONSE - L'autre possibilité à POST est GET. POST servira lorsque l'on veut envoyer des données et GET pour les récupérer -->
    ...
    <span class="form_hint">Les champs obligatoires sont indiqués par *</span>  
		<div class="form-group">
            ...
            <!-- REPONSE - Attribut NAME : Possibilité de nommage identique multiple -->
            <!-- REPONSE - Attribut ID : Nommage identique unique, c'est ce qui identifie, donc 1 id correspond à 1 élément -->
            <!-- c'est lequel qui doit être égal à l'attribut for du label ? --> 
            <!-- REPONSE - L'attribut qui doit être égal au FOR du label est l'ID -->   
		</div>
		<div class="form-group">  
            ...
            <!-- REPONSE - Quand le mot de passe comporte mois de 6 charactères et quand il en comporte plus de 8 -->   
		...
		<div class="form-group">  
            ...
            <!-- REPONSE - On ne va pas récupérer les données de cette cellule, ici on ne cherche qu'à vérifier l'égalité avec la cellule précédente et on enverra donc cette première cellule -->
            <!-- quel scénario justifie qu'on ait ajouté l'écouter validateMdp2() à l'évènement onkeyup de l'input mdp1 ? -->  
            <!-- REPONSE - On va vérifier que mdp1 respecte le RegEx pour ensuite vérifier la correspondance avec mdp2 -->   
            <script>  
		...
		<div class="form-group">  
            ...
            <!-- REPONSE - Ici, l'input sera désactivé, l'utilisateur ne pourra pas saisir à l'intérieur ni cliquer' -->
		</div>
		<div class="form-group">  
